            ...
            <div className="mainpage-container">
                ...
                <section className='image_and_download'>
                    ...
                    <div className="img_and_download-container">
                        ...
                        <div className='downlload-btn-mainpage-1'>  {button &&
                        <Button buttonStyle='btn--Bazar' buttonSize='btn--large'> </Button>} </div>

                        <div className='downlload-btn-mainpage-2'>  {button &&
                        <Button buttonStyle='btn--Bazar' buttonSize='btn--large'> </Button>} </div>
